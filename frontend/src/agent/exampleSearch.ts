...
// on this fork write 繁體中文 (溫度/序列埠/伺服馬達…), while zh-cn users and
// older saved chats use the Simplified forms.
const ZH_KEYWORDS: Array<[RegExp, string[]]> = [
  [/红绿灯|交通灯|紅綠燈|交通燈/, ['traffic', 'light']],
  [/超声波|测距|距离|超音波|測距|距離/, ['ultrasonic', 'hc-sr04', 'distance']],
  [/按钮|按键|按鈕|按鍵/, ['button', 'pushbutton']],
  [/电位器|旋钮|電位器|旋鈕|可變電阻/, ['potentiometer']],
  [/呼吸灯|渐变|pwm|调光|呼吸燈|漸變|調光/i, ['fade', 'pwm', 'dimmer', 'breathing']],
  [/舵机|伺服馬達|伺服马达/, ['servo']],
  [/蜂鸣器|音乐|旋律|蜂鳴器|音樂/, ['buzzer', 'melody', 'tone']],
  [/温度|湿度|溫度|濕度/, ['dht', 'ds18b20', 'temperature', 'humidity']],
  [/温湿度|溫濕度/, ['dht22', 'dht11']],
  [/防水温度|水温|一线|防水溫度|水溫|一線|1-wire/i, ['ds18b20', 'onewire']],
  [/oled|屏幕|显示屏|螢幕|顯示器/i, ['oled', 'ssd1306', 'display']],
  [/lcd|液晶/i, ['lcd', 'lcd1602']],
  [/数码管|七段顯示器|七段显示/, ['seven', 'segment', '7-segment']],
  [/led|灯|燈/i, ['led', 'blink']],
  [/闪烁|闪灯|閃爍|閃燈/, ['blink']],
  [/继电器|繼電器/, ['relay']],
  [/光敏|光线|亮度传感|光線|亮度感測/, ['ldr', 'photoresistor', 'light sensor']],
  [/摇杆|搖桿/, ['joystick']],
  [/点阵|點陣/, ['matrix', 'max7219']],
  [/rgb/i, ['rgb']],
  [/串口|序列埠/, ['serial']],
  [/红外|紅外/, ['ir', 'infrared']],
  [/步进电机|步進馬達|步进马达/, ['stepper']],
  [/电机|马达|馬達|電機/, ['motor']],
  [/键盘|矩阵键盘|鍵盤|矩陣鍵盤/, ['keypad']],
  [/时钟|時鐘|rtc/i, ['rtc', 'clock', 'ds1307']],
  [/wifi|联网|連網|上网|上網|無線|无线/i, ['wifi', 'esp32']],
  [/mqtt|云端|雲端|物联网|物聯網|iot/i, ['mqtt', 'iot', 'esp32']],
  [/服务器|伺服器|网页|網頁|http/i, ['server', 'http', 'web']],
];
